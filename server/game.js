...
export const WORLD = { radius: 5500 };
...
const FOOD_TARGET = 1800;        // scales with the larger world (keeps decent food density)
const BOT_TARGET = 14;           // bots kept alive to fill the (now larger) arena
